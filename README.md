...
每个类的定义都应该带些注释, 说明它是用于干什么的, 以及怎么用它.
...
module Translation
  ...
  # 转换 美式英语 到 英式英语.
  # 除了常见的殖民地英语变形, 把 "apartment" 转成 "flat".
...
这些注释应该是描述性的(descriptive) 比如 ("Opens the file")  
而不是命令式的(imperative) 比如 ("Open the file");   
